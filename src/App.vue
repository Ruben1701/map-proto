<template>
  <div class="geo-points">
    ...
    <ul>
      ...
      <li v-for="villa in paginatedVillas" :key="villa.id" @mouseover="highlightMarker(villa)"
        @mouseleave="unhighlightMarker(villa)">
        <!-- <router-link :to="{ name: 'villa-details', params: { id: villa.id }}" :villa="villa"> -->
        ...
        <!-- </router-link> -->
          ...
          <br>
          <p>Distance to beach: {{ villa.nearest_beach.distance }}$</p>
          <p>Closest City: {{ villa.nearest_City.name }}</p>
      </li>
    </ul>
